...
<body>
  <div class="register-bg d-flex justify-content-center align-items-center min-vh-100">
    <div class="card register-card p-4 shadow">
      <h2 class="text-center mb-3 text-danger">JDelivery Restaurant Signup</h2>
      <form id="register-form" action="${pageContext.request.contextPath}/RestaurantRegistration" method="post">
        <div class="mb-3">
      ...
      <div class="text-center mt-3">
        ...
        <a href="RestaurantLogin.jsp" class="link-danger">Login</a>
      </div>
    </div>
  </div>
